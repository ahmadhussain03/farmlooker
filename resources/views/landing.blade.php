...
<meta name="keywords" content="Farmlooker" />
<meta name="description" content="Farmlooker" />
<meta name="author" content="https://www.beanband.com/" />
<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" />
<title>Farmlooker</title>
...
<!-- flaticon -->
<link rel="stylesheet" type="text/css" href="landing/css/flaticon.css"/>


<!-- REVOLUTION LAYERS STYLES -->

<link rel="stylesheet" type="text/css" href="landing/revolution/css/rs6.css">

<!-- prettyphoto -->
<link rel="stylesheet" type="text/css" href="landing/css/prettyPhoto.css">

<!-- shortcodes -->
<link rel="stylesheet" type="text/css" href="landing/css/shortcodes.css"/>
    ...
    <div class="page">
                                ...
                                <div class="col-lg-12">
                                    <div class="d-flex flex-row align-items-center">
                                        ...
                                        <div class="site-branding mr-auto">
                                            <a class="home-link" href="index.html" title="Farmlooker" rel="home">
                                                <img src="landing/images/logo.png" id="logo-img" class="img-center" alt="logo">
                                            </a>
        ...
        <rs-module-wrap id="rev_slider_1_1_wrapper" data-source="gallery">
            <rs-module id="rev_slider_1_1" data-version="6.1.2" class="rev_slider_1_1_height">
                <rs-slides>
                    <rs-slide data-key="rs-5" data-title="Slide" data-thumb="landing/images/slides/slider-mainbg-005.jpg" data-anim="ei:d;eo:d;s:d;r:0;t:zoomout;sl:d;">
                        <img src="landing/images/slides/slider-mainbg-005.jpg" title="sliderbg-005.jpg" width="1920" height="910" class="rev-slidebg" data-no-retina>
                        <rs-layer
                            id="slider-3-slide-1-layer-1"
                            class="head-font"
                            data-type="text"
                            data-rsp_ch="on"
                            data-xy="x:c;yo:317px,317px,199px,133px;"
                        ...
                        <rs-layer
                            ...
                            data-type="text"
                            data-rsp_ch="on"
                            data-xy="x:c;xo:0,0,0,455px;yo:203px,203px,108px,129px;"
                        ...
                        <rs-layer
                            ...
                            data-type="text"
                            data-rsp_ch="on"
                            data-xy="x:c;yo:238px,238px,135px,92px;"
                            data-text="w:normal;s:70,70,55,35;l:85,85,60,45;fw:700;"
                            data-frame_0="y:100%;"
                        ...
                        <a
                            ...
                            data-type="text"
                            data-rsp_ch="on"
                            data-xy="x:c;yo:424px,424px,276px,192px;"
                            ...
                            data-frame_hover="bgc:#c16914;boc:rgba(132,193,58,0);bor:50%,50%,50%,50%;"
                        ...
                        <a
                            ...
                            data-type="text"
                            data-rsp_ch="on"
                            data-xy="x:c;yo:480px,480px,326px,241px;"
                    ...
                    <rs-slide data-key="rs-6" data-title="Slide" data-thumb="images/slides/slider-mainbg-006.jpg" data-anim="ei:d;eo:d;s:d;r:0;t:zoomout;sl:d;">
                        <img src="landing/images/slides/slider-mainbg-006.jpg" title="sliderbg-006.jpg" width="1920" height="910" class="rev-slidebg" data-no-retina>
                        <rs-layer
                            id="slider-3-slide-2-layer-1"
                            class="head-font"
                            data-type="text"
                            data-rsp_ch="on"
                            data-xy="x:c;yo:321px,321px,214px,139px;"
                        ...
                        <rs-layer
                            ...
                            data-type="text"
                            data-rsp_ch="on"
                            data-xy="x:c;xo:0,0,0,455px;yo:214px,214px,126px,129px;"
                        ...
                        <rs-layer
                            ...
                            data-type="text"
                            data-rsp_ch="on"
                            data-xy="x:c;yo:247px,247px,150px,100px;"
                            data-text="w:normal;s:70,70,55,35;l:85,85,60,45;fw:600;"
                            data-frame_0="y:100%;"
                            data-frame_1="e:Linear.easeNone;st:230;sp:900;sR:230;"
                            data-frame_999="o:0;st:w;sR:7870;"
                        ...
                        <a
                            ...
                            data-type="text"
                            data-rsp_ch="on"
                            data-xy="x:c;yo:435px,435px,294px,204px;"
                            data-text="w:normal;s:15,15,12,12;l:20,20,14,12;fw:600;"
        ...
        <div class="site-main">
            ...
            <!-- services-section -->
            <section class="ttm-row zero-padding-section ttm-bgcolor-skincolor clearfix">
                    ...
                    <div class="row"><!-- row -->
                            ...
                            <div class="featured-icon-box left-icon style7">
                                <div class="featured-icon"><!--  featured-icon -->
                                    <div class="ttm-icon ttm-icon_element-color-white ttm-icon_element-size-lg">
                                        <i class="flaticon flaticon-cow-1"></i><!--  ttm-icon -->
                                    </div>
                                </div>
                                <div class="featured-content"><!--  featured-content -->
                                    <div class="featured-title"><!--  featured-title -->
                                        <h5>Milk Cooling & Storage</h5>
                                    </div>
                                    <div class="featured-desc"><!--  featured-desc -->
                                        <p>Contrary to popular belief, Lorem Im is not simply random.</p>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="featured-icon-box left-icon style7">
                                <div class="featured-icon"><!--  featured-icon -->
                                    <div class="ttm-icon ttm-icon_element-color-white ttm-icon_element-size-lg">
                                        <i class="flaticon flaticon-dairy-products"></i><!--  ttm-icon -->
                                    </div>
                                </div>
                                <div class="featured-content"><!--  featured-content -->
                                    <div class="featured-title"><!--  featured-title -->
                    ...
                    <div class="row"><!-- row -->
                        <div class="col-lg-5">
                            <div class="border-12px-solid grey-border p-30 col-bg-img-seven">
                                <h3 class="fw-700">For Services & Immediate Attention 24/7</h3>
                                <div class="mt-25">
                                    <ul class="ttm-list ttm-list-style-icon style2">
                                        ...
                                        <li><i class="fa fa-check-circle-o ttm-textcolor-skincolor"></i><span class="ttm-list-li-content">Low Prices</span></li>
                                        <li><i class="fa fa-check-circle-o ttm-textcolor-skincolor"></i><span class="ttm-list-li-content">The Best Quality</span></li>
                                        <li><i class="fa fa-check-circle-o ttm-textcolor-skincolor"></i><span class="ttm-list-li-content">A Professional Team</span></li>
                                        <li><i class="fa fa-check-circle-o ttm-textcolor-skincolor"></i><span class="ttm-list-li-content">Stone and Hardscaping</span></li>
                                    </ul>
                                </div>
                                <div class="">
                                    <a href="#" class="ttm-btn ttm-btn-size-md ttm-btn-bgcolor-darkgrey"> Check Our Offer</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-7">
                            <div class="res-991-mt-30">
                                ...
                                <div class="section-title clearfix">
                                    <div class="title-header">
                                        <h5>About farming</h5>
                                        <h2 class="title">Welcome To Farmlooker</h2>
                                    </div>
                                ...
                                <div class="row mt-30">
                                    <div class="col-md-4 col-lg-4 col-sm-4">
                                        <div class="text-left pt-15">
                                            <img src="landing/images/about-sign.png" alt="about-sign">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="ml_130 res-991-ml-0">
                                            ...
                                            <div class="ttm_single_image-wrapper after-border style1 position-relative">
                                                <img class="img-fluid" src="landing/images/single-img-three.jpg" title="single-img-three" alt="single-img-three">
            ...
            <section class="ttm-row progress-bar-section ttm-bgcolor-skincolor ttm-bg ttm-bgimage-yes bg-img3 clearfix">
                <div class="ttm-row-wrapper-bg-layer ttm-bg-layer"></div>
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="ttm-bgcolor-white position-relative z-1 spacing-8"><!-- row -->
                                <div class="row">
                                    <div class="col-lg-6">
                                        <!-- ttm_single_image-wrapper -->
                                        <div class="ttm_single_image-wrapper mt_75">
                                            <img class="img-fluid" src="landing/images/single-img-four.jpg" title="single-img-four" alt="single-img-four">
                                        </div><!-- ttm_single_image-wrapper end -->
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="spacing-7">
                                            ...
                                            <div class="section-title clearfix">
                                                <div class="title-header">
                                                    <h5>Why Choose Us?</h5>
                                                    <h2 class="title">We Have 35 Years<br> experience in Agriculture </h2>
                                                </div>
                                                <div class="heading-seperator">
                                                    <span></span>
                                                </div>
            ...
            <!-- portfolio-section -->
            <section class="ttm-row second-portfolio-text-section ttm-bgcolor-darkgrey clearfix">
                <div class="container-fluid">
                    <div class="row"><!-- row -->
                        <div class="col-lg-12">
                            <!-- section title -->
            ...
            <!-- portfolio-section -->
            <div class="ttm-row topzero-padding-section mt_190 clearfix">
                <div class="container-fluid">
                    <div class="row slick_slider ttm-boxes-spacing-5px" data-slick='{"slidesToShow": 5, "slidesToScroll": 5, "dots":false, "arrows":false, "autoplay":false, "infinite":true, "centerMode":false}'>
                        <div class="col-lg ttm-box-col-wrapper">
                            <!-- featured-imagebox -->
                            <div class="featured-imagebox featured-imagebox-portfolio style1">
                                <div class="featured-thumbnail"><!-- featured-thumbnail-->
                                    <img class="img-fluid" src="landing/images/portfolio/07.jpg" alt="image">
                                </div><!-- featured-thumbnail END-->
                                <div class="ttm-box-view-overlay"> <!-- ttm-box-view-overlay -->
                                    <div class="ttm-media-link"><!-- ttm-media-link-->
                                        <a class="ttm_prettyphoto ttm_image" data-gal="prettyPhoto[gallery1]" title="" href="images/portfolio/07.jpg" data-rel="prettyPhoto">
                                            <i class="ti ti-search"></i>
                                        </a>
                                    </div>
                        ...
                        <div class="col-lg ttm-box-col-wrapper">
                            ...
                            <div class="featured-imagebox featured-imagebox-portfolio style1">
                                <div class="featured-thumbnail"><!-- featured-thumbnail-->
                                    <img class="img-fluid" src="landing/images/portfolio/08.jpg" alt="image">
                                </div><!-- featured-thumbnail END-->
                                <div class="ttm-box-view-overlay"> <!-- ttm-box-view-overlay -->
                                    <div class="ttm-media-link"><!-- ttm-media-link-->
                                        <a class="ttm_prettyphoto ttm_image" data-gal="prettyPhoto[gallery1]" title="" href="images/portfolio/08.jpg" data-rel="prettyPhoto">
                                            <i class="ti ti-search"></i>
                                        </a>
                                    </div>
                                </div><!-- ttm-box-view-overlay end-->
                        ...
                        <div class="col-lg ttm-box-col-wrapper">
                            ...
                            <div class="featured-imagebox featured-imagebox-portfolio style1">
                                <div class="featured-thumbnail"><!-- featured-thumbnail-->
                                    <img class="img-fluid" src="landing/images/portfolio/09.jpg" alt="image">
                                </div><!-- featured-thumbnail END-->
                                <div class="ttm-box-view-overlay"> <!-- ttm-box-view-overlay -->
                                    <div class="ttm-media-link"><!-- ttm-media-link-->
                                        <a class="ttm_prettyphoto ttm_image" data-gal="prettyPhoto[gallery1]" title="" href="images/portfolio/09.jpg" data-rel="prettyPhoto">
                                            <i class="ti ti-search"></i>
                                        </a>
                                    </div>
                                </div><!-- ttm-box-view-overlay end-->
                        ...
                        <div class="col-lg ttm-box-col-wrapper">
                            ...
                            <div class="featured-imagebox featured-imagebox-portfolio style1">
                                <div class="featured-thumbnail"><!-- featured-thumbnail-->
                                    <img class="img-fluid" src="landing/images/portfolio/10.jpg" alt="image">
                                </div><!-- featured-thumbnail END-->
                                <div class="ttm-box-view-overlay"> <!-- ttm-box-view-overlay -->
                                    <div class="ttm-media-link"><!-- ttm-media-link-->
                                        <a class="ttm_prettyphoto ttm_image" data-gal="prettyPhoto[gallery1]" title="" href="images/portfolio/10.jpg" data-rel="prettyPhoto">
                                            <i class="ti ti-search"></i>
                                        </a>
                                    </div>
                                </div><!-- ttm-box-view-overlay end-->
                        ...
                        <div class="col-lg ttm-box-col-wrapper">
                            ...
                            <div class="featured-imagebox featured-imagebox-portfolio style1">
                                <div class="featured-thumbnail"><!-- featured-thumbnail-->
                                    <img class="img-fluid" src="landing/images/portfolio/11.jpg" alt="image">
                                </div><!-- featured-thumbnail END-->
                                <div class="ttm-box-view-overlay"> <!-- ttm-box-view-overlay -->
                                    <div class="ttm-media-link"><!-- ttm-media-link-->
                                        <a class="ttm_prettyphoto ttm_image" data-gal="prettyPhoto[gallery1]" title="" href="images/portfolio/11.jpg" data-rel="prettyPhoto">
                                            <i class="ti ti-search"></i>
                                        </a>
                                    </div>
                                </div><!-- ttm-box-view-overlay end-->
                        ...
                        <div class="col-lg ttm-box-col-wrapper">
                            ...
                            <div class="featured-imagebox featured-imagebox-portfolio style1">
                                <div class="featured-thumbnail"><!-- featured-thumbnail-->
                                    <img class="img-fluid" src="landing/images/portfolio/12.jpg" alt="image">
                                </div><!-- featured-thumbnail END-->
                                <div class="ttm-box-view-overlay"> <!-- ttm-box-view-overlay -->
                                    <div class="ttm-media-link"><!-- ttm-media-link-->
                                        <a class="ttm_prettyphoto ttm_image" data-gal="prettyPhoto[gallery1]" title="" href="images/portfolio/12.jpg" data-rel="prettyPhoto">
                                            <i class="ti ti-search"></i>
                                        </a>
                                    </div>
                                </div><!-- ttm-box-view-overlay end-->
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="text-center mt-30 res-991-mt-10">
                                <a href="#" class="ttm-btn ttm-btn-size-md ttm-btn-bgcolor-darkgrey mt-20 mr-10"> View More Gallery</a>
                                <a href="#" class="ttm-btn ttm-btn-size-md ttm-btn-bgcolor-skincolor mt-20"> Contact Us</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!-- price-text-section -->
            <section class="ttm-row price-text-section bg-img8 ttm-bgcolor-grey ttm-bg ttm-bgimage-yes clearfix">
                <div class="ttm-row-wrapper-bg-layer ttm-bg-layer"></div>
                <div class="container-fluid">
                    <div class="row"><!-- row -->
                        <div class="col-lg-12">
            ...
            <!-- priceplan-section -->
            <section class="ttm-row topzero-padding-section mt_220  clearfix">
                <div class="container">
                    <!-- row -->
            ...
            <!-- priceplan-section -->
            <!-- testimonial-section -->
            <section class="ttm-row second-testimonial-section ttm-bgcolor-darkgrey ttm-bg ttm-bgimage-yes bg-img9 clearfix">
                <div class="ttm-row-wrapper-bg-layer ttm-bg-layer"></div>
                <div class="container">
                    <div class="row"><!-- row -->
                        <div class="col-lg-12">
                            ...
                            <div class="testimonials-nav">
                                <div class="testimonial-avatar">
                                    <div class="testimonial-img">
                                        <img class="img-fluid" src="landing/images/testimonial/01.jpg" alt="testimonial-img">
                                    </div>
                                </div>
                                <div class="testimonial-avatar">
                                    <div class="testimonial-img">
                                        <img class="img-fluid" src="landing/images/testimonial/02.jpg" alt="testimonial-img">
                                    </div>
                                </div>
                                <div class="testimonial-avatar">
                                    <div class="testimonial-img">
                                        <img class="img-fluid" src="landing/images/testimonial/03.jpg" alt="testimonial-img">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="testimonials-info">
                                <div class="testimonials">
                                    <div class="testimonial-content">
                                        ...
                                        <blockquote class="testimonial-text">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit.</blockquote>
                                        <div class="testimonial-caption ttm-textcolor-white">
                                            <h6>RAshley Foster</h6>
                    ...
                    <div class="row slick_slider" data-slick='{"slidesToShow": 3, "slidesToScroll": 3, "dots":false, "arrows":false, "autoplay":false, "infinite":true, "centerMode":false}'>
                        <div class="col-lg-12">
                            ...
                            <div class="featured-imagebox featured-imagebox-blog style1 box-shadow">
                                <div class="featured-thumbnail"><!-- featured-thumbnail -->
                                    <img class="img-fluid" src="landing/images/blog/04.jpg" alt="">
                                    <div class="blog-icon">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="featured-imagebox featured-imagebox-blog style1 box-shadow">
                                <div class="featured-thumbnail"><!-- featured-thumbnail -->
                                    <img class="img-fluid" src="landing/images/blog/07.jpg" alt="">
                                    <div class="blog-icon">
                                        <i class="ti ti-pencil"></i>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="featured-imagebox featured-imagebox-blog style1 box-shadow">
                                <div class="featured-thumbnail"><!-- featured-thumbnail -->
                                    <img class="img-fluid" src="landing/images/blog/06.jpg" alt="">
                                    <div class="blog-icon">
                                        <i class="ti ti-pencil"></i>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-3 widget-area">
                            <div class="widget widget_text  clearfix">
                                <h3 class="widget-title"> About Farmlooker</h3>
                                <div class="">
                                    <p>Farmlooker is passionate about farming and agriculture, gardening services related websites.</p>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-3 widget-area">
                            <div class="widget widget_text clearfix">
                                ...
                                <ul class="widget-post ttm-recent-post-list">
                                    <li>
                                        <a href="single-blog.html"><img src="landing/images/blog/01.jpg" alt="post-img"></a>
                                    ...
                                    <li>
                                        <a href="single-blog.html"><img src="landing/images/blog/02.jpg" alt="post-img"></a>
                                    ...
                                    <li>
                                        <a href="single-blog.html"><img src="landing/images/blog/03.jpg" alt="post-img"></a>
                    ...
                    <div class="row copyright">
                        <div class="col-md-12">
                            <div class="text-center">
                                <span>Copyright © 2021&nbsp;<a href="#">Farmlooker</a></span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <script src="landing/js/jquery-waypoints.js"></script>
        ...
        <script src="landing/js/numinate.min6959.js?ver=4.9.3"></script>
        <script src="landing/js/main.js"></script>

        <!-- Revolution Slider -->
        <script src="landing/revolution/js/revolution.tools.min.js"></script>
        <script src="landing/revolution/js/rs6.min.js"></script>
        <script src="landing/revolution/js/slider.js"></script>
